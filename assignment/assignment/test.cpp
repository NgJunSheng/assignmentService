...
//#include <limits> // for password need to minimum how many
//#include <cctype>
//
//using namespace std;
//
...
//
//    Services addService;
//    addService.serviceID = "SI" + to_string(serviceCounter++);
//    cout << "\n========== ADD SERVICE ==========\n";
//    cout << "Service ID: "
//        << addService.serviceID << "\n";
//
//    cout << "Enter Service Name: ";
//    getline(cin, addService.servicename);
//
//    cout << "Enter Price: RM ";
//    cin >> addService.price;
//
//    cout << "Enter Duration (minutes): ";
//    cin >> addService.duration;
//
//    if (addService.servicename.empty() || addService.price <= 0 || addService.duration <= 0) {
//        cout << "[Error] Invalid service information.\n";
//        return;
//    }
//
//    servicesDB[MAX_SERVICES] = addService;
//    servicecount++;
//
...
//    cout << "\nAvailable Staff:\n";
//    for (int i = 0; i < staffCount; i++) {
//        cout << staffDB[i].staffID << " - " << staffDB[i].nameStaff << "\n";
//    }
//
//    cout << "Enter Staff ID: ";
//    cin >> newBooking.staffID;
